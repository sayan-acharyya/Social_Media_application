...
const SignUp = () => {
    ...
    from-black  to-gray-900 flex flex-col justify-center items-center'>
      ...
      ${inputClick.name ? "top-[-8px] text-xs text-blue-500" : "top-[13px] text-sm"}`}
                        >
                            Enter Your Name
                        </label>
                        ...
                        <input
                            ...
                            type="text"
                            onBlur={(e) =>
                                setInputClick({ ...inputClick, name: e.target.value !== "" })
                            }
      ...
      ${inputClick.userName ? "top-[-8px] text-xs text-blue-500" : "top-[13px] text-sm"}`}
                    ...
                    >
                        <label
                            htmlFor="email"
                            className={`absolute left-4 bg-white px-1 text-gray-600 transition-all duration-200
      ${inputClick.email ? "top-[-8px] text-xs text-blue-500" : "top-[13px] text-sm"}`}
                        >
                            Enter Your Email
                        </label>
...
bg-black text-white rounded-l-[30px]
